...
# FIs that always appear in the report even with no raw data (show 0,0,0,0)
PERMANENT_FIS = [
...
def generate_report(input_path: str, output_path: str, report_date: datetime):
    ...
    ws["C6"] = "No.Transactions"
    ws["D6"] = "Values"
    ws["E6"] = "No.Transactions"
    ws["F6"] = "Values"
...
if __name__ == "__main__":
    input_file  = sys.argv[1] if len(sys.argv) > 1 else "/mnt/user-data/uploads/IPS_success_for_source_and_destination_6_.xlsx"
    ...
    generate_report(input_file, output_file, report_date)
